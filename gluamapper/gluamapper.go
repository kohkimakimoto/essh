// see the original gluamapper https://github.com/yuin/gluamapper

// I hacked it to convert lua table to json.
// The original gluamapper raises error the following converting operation.
//
// lua table -> map[string]interface{} -> json marshal
//
// error:
